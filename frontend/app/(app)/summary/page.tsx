    ...
    >
      ...
      <div className="flex items-start justify-between px-5 pt-3 pb-4">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            <h2 className="text-lg font-bold" style={{ color: "#f0eeff" }}>{today}</h2>
          ...
          <p className="text-xs" style={{ color: "rgba(255,255,255,0.4)" }}>날짜와 내용을 수정할 수 있어요</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          {/* 삭제 버튼 */}
          <button
            onClick={() => { clearSummary(); clearMessages(); clearSession(); router.push("/home"); }}
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          />
          <p className="text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>대화 내용을 분석하고 있어요...</p>
        </div>
      )}
      ...
      {!loading && messages.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 gap-4 px-6">
          ...
          <p className="text-center text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>대화 내용이 없습니다.<br />먼저 AI와 대화를 해보세요.</p>
          <button
      ...
      {summary && (
        <div style={{
          display: "flex", gap: "10px", padding: "10px 20px 14px", flexShrink: 0,
          background: "rgba(0,0,0,0.15)", borderTop: "1px solid rgba(255,255,255,0.06)",
        }}>
          <button onClick={handleContinue} style={{
            flex: 1, padding: "13px", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.15)",
          ...
          <button onClick={handleSave}
            ...
            {saveState === "saving" ? "저장 중..." : saveState === "saved" ? "저장됨 ✓" : "기록 저장하기"}
          </button>
        </div>
      )}
      ...
      <AnimatePresence>
        {toastMsg && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="absolute bottom-28 left-1/2 -translate-x-1/2 px-5 py-3 rounded-2xl text-white text-sm font-medium shadow-lg z-50 whitespace-nowrap"
